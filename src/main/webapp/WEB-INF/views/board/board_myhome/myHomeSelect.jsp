...
// 카카오톡 공유하기
 Kakao.Share.createDefaultButton({
            ...
            content: {
                ...
                description: '우리집을 소개합니다.',
                imageUrl: `http://www.naeilhomeshop.kro.kr/board/board_myhome/myHomeCoverImages.do?articleNo=${selectMyHome.boardMyhomeArticleNo}&image=${selectMyHome.imageFileName}`,
                link: {
            ...
            buttons: [
                {
                    title: '홈페이지 바로가기',
                    link: {
                        webUrl: `http://www.naeilhomeshop.kro.kr/board/board_myhome/myHomeSelect.do?boardMyhomeArticleNo=${selectMyHome.boardMyhomeArticleNo}`,
