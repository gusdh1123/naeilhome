...
<script> Kakao.init('8d04e445858985aaaed27e26696055a4'); </script>
...
// 카카오톡 공유하기
document.getElementById('kakaotalk-sharing-btn').addEventListener('click', function(event) {
	    ...
	    Kakao.Share.createDefaultButton({
	        ...
	        content: {
	            ...
	            imageUrl: `http://www.naeilhomeshop.kro.kr/product/selectThumnail.do?productNO=${productDomain.productNO}&image=${selectThumnail.imageFilename[0]}`,
	            link: {
	                webUrl: 'http://www.naeilhomeshop.kro.kr',
	            },
	        },
	        social: {},
	        buttons: [
	            {
	                title: '홈페이지 바로가기',
	                link: {
	                    webUrl: `http://www.naeilhomeshop.kro.kr/product/selectProduct.do?productNO=${productDomain.productNO}&productName=${productDomain.productName}`,
	                },
	            },
	        ],
	    });
